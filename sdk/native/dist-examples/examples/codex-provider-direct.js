...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var provider, model, agent, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, provider.getModel('gpt-5')];
                case 1:
                    model = _a.sent();
                    agent = new agents_1.Agent({
                        name: 'CodexAssistant',
                        model: model,
                        instructions: 'You are a helpful coding assistant powered by GPT-5 through Codex. You support both text and image inputs.',
                    });
                    // Run the agent with text input
                    console.log('Example 1: Text input\n');
                    return [4 /*yield*/, (0, agents_1.run)(agent, 'What is the capital of France?')];
                case 2:
                    result = _a.sent();
                    console.log('\nAgent response:');
