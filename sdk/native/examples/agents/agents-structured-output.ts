...
async function main() {
  ...
  const agentWithSchema = new Agent({
    ...
    outputType: { type: 'json_schema', schema: simpleSchema },
  });
  ...
  const taskAgent = new Agent({
    ...
    outputType: { type: 'json_schema', schema: complexSchema },
  });
  ...
  const zodAgent = new Agent({
    ...
    outputType: { type: 'json_schema', schema: jsonSchemaFromZod },
  });
  ...
  const listAgent = new Agent({
    ...
    outputType: { type: 'json_schema', schema: arraySchema },
  });
