...
export function createDefaultSolverConfig(workingDirectory: string): SolverConfig {
  return {
    ...
    supervisorModel: "gpt-5.1-codex-max",
    workerModelHigh: DEFAULT_REVIEWER_MODEL,
    workerModelLow: DEFAULT_WORKER_MODEL,
    highReasoningMatchers: ["^codex-rs/core/", "^codex-rs/app-server/", "^codex-rs/common/", "^\\.github/workflows/"],
    lowReasoningMatchers: ["^docs/", "README\\.md$"],
